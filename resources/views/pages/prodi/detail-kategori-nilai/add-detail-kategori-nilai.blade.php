...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Tambah Detail Kategori Nilai</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="card-body">
                            ...
                            <form id="formTambah" method="post" action="{{ route('kategori.nilai.detail.store') }}">
                                ...
                                <div class="form-group">
                                    <label for="kategori">Detail Kategori Nilai <span
                                ...
                                <!-- Persentase -->
                                <div class="form-group">
                                    <label for="persentase">Detail Persentase <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="mr-2">
                                        <a href="{{ route('kategori.nilai.detail', $slug) }}"
