...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Daftar Research</h1>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <table id="table-data" class="table table-bordered table-striped" style="font-size: 0.9em; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $d->topik_penelitian }}</td>
                                        <td>{{ $d->kode_penelitian }}</td>
                                        <td>{{ $d->deskripsi }}</td>
                                        <td>
                                            <a class="btn btn-info btn-sm btn-edit-data mr-1" href="{{ route('research.edit', $d->uuid) }}">
