...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Daftar Research Dosen</h1>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card card-outline card-info scroll">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Daftar Research Dosen
                                </h3>
                                <div class="card-tools">
                                    <a href="{{ route('research.dosen.create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-sm btn-edit-data mr-1"
                                                href="{{ route('research.dosen.edit', $d->uuid) }}">
