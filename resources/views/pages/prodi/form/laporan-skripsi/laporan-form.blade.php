...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">Form Laporan Skripsi</h1>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="card card-outline card-info scroll">
            ...
            <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                <h3 class="card-title">
                  Form Laporan Skripsi
                </h3>
                <div class="card-tools">
                  <a href="{{ route('laporan.skripsi.form.create') }}" class="btn btn-primary btn-sm">
            ...
            <div class="card-body">
              <table id="table-data" class="table table-bordered table-striped" style="font-size: 0.85em; width: 100%;">
                <thead>
                  <tr>
                    <th style="width: 5%;">#</th>
                    <th style="width: 20%;">Judul Laporan Skripsi Form</th>
                    <th>Dibuka</th>
                    <th>Ditutup</th>
                  ...
                  <tr data-child-value="{{ $d->keterangan }}">
                    ...
                    <td>
                      <a class="btn btn-info btn-sm btn-edit-data mr-1"
                        href="{{ route('laporan.skripsi.form.edit', $d->uuid) }}">
