...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">Buat Form Laporan Skripsi</h1>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="card card-outline card-info scroll">
            ...
            <div class="card-body">
              <!-- Form -->
              <form id="formTambah" method="post" action="{{ route('laporan.skripsi.form.store') }}">
                @csrf
                ...
                <div class="d-flex flex-row">
                  ...
                  <div class="mr-2">
                    <a href="{{ route('laporan.skripsi.form') }}" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
