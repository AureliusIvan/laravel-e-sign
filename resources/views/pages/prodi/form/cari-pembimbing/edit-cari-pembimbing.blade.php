...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Edit Form Cari Pembimbing</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-outline card-info scroll">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                Edit Form Cari Pembimbing
                            </h3>
                            <div class="card-tools">
                                @if ($isLinked === false)
                                <form action="{{ route('caripembimbing.form.destroy') }}" method="post">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form id="formTambah" method="post" action="{{ route('caripembimbing.form.update', $data->uuid) }}">
                                @csrf
                                @method('PUT')
