...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Buat Form Cari Pembimbing</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="card card-outline card-info scroll">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form id="formTambah" method="post" action="{{ route('caripembimbing.form.store') }}">
                                @csrf
