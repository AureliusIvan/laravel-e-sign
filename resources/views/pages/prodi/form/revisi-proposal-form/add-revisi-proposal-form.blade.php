            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="card card-outline card-info scroll">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form id="formTambah" method="post" action="{{ route('revisi-proposal.skripsi.form.store') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="proposal_form" id="proposal_form" class="form-control" required>
                                            ...
                                            @foreach ($form as $row)
                                            <option value="{{ $row->uuid }}" {{ old('proposal_form') == $row->uuid ? 'selected' : '' }}>
                                                {{ $row->judul_form }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="mr-2">
                                        <a href="{{ route('revisi-proposal.skripsi.form') }}" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </div>
