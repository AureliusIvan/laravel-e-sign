...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Form Proposal Skripsi</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('proposal.skripsi.form.create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <tr data-child-value="{{ $d->keterangan }}">
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-sm btn-edit-data mr-1"
                                                href="{{ route('proposal.skripsi.form.edit', $d->uuid) }}">
