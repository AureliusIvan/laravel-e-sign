...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">Periksa Revisi Skripsi</h1>
        </div>
      </div>
    </div>
  </section>
            ...
            <div class="card-body">
              <table id="table-data" class="table table-bordered table-striped" style="font-size: 0.85em; width: 100%;">
                <thead>
                  <tr>
                    <th style="width: 5%;">#</th>
                    <th style="width: 30%;">Judul Revisi Skripsi Form</th>
                    <th>Ditutup</th>
                ...
                <tbody>
                  ...
                  <tr data-child-value="{{ $d->keterangan }}">
                    ...
                    <td>
                      <a href="{{ route('revisi-proposal-skripsi.periksa.show', $d->uuid) }}"
