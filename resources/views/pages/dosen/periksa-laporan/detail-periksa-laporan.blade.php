...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold">Periksa Laporan Skripsi</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('laporan.skripsi.periksa') }}" id="btn-download"
                        ...
                        <div class="card-body">
                            <table id="table-data" class="table table-bordered table-striped"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            @if ($row->status_approval_pembimbing1 === null)
                                            <span class="right badge badge-danger">New</span>
                                            @elseif ($row->status_approval_pembimbing1 === 2)
                                            <span class="right badge badge-danger">New</span>
                                            @elseif ($row->pembimbing2 !== null)
                                            @if ($row->status_approval_pembimbing2 === 3)
                                            <span class="right badge badge-danger">New</span>
                                            @endif
                                            @elseif ($row->status_approval_kaprodi === 3)
                                            <span class="right badge badge-danger">New</span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($row->file_laporan !== null)
                                            <a href="{{ route('laporan.skripsi.periksa.getfile', $row->uuid) }}"
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            @elseif ($row->file_pembimbing1 !== null)
                                            @if ($row->status_approval_pembimbing1 == 2 &&
                                            $row->status_approval_pembimbing2 == 2 &&
                                            ...
                                            @else
                                            <a href="{{ route('laporan.skripsi.periksa.file-pembimbing1', $row->uuid) }}"
                                                class="btn btn-info btn-sm" target="_blank">
                                                <i class="fas fa-download mr-1"></i>
                                                Download
                                            </a>
                                        ...
                                        <td>
                                            @if ($row->status_approval_pembimbing2 === 3)
                                            <span class="text-danger font-weight-bold">Ditolak Pembimbing 2</span>
                                            @elseif ($row->status_approval_kaprodi === 3)
                                            <span class="text-danger font-weight-bold">Ditolak Kaprodi</span>
                                            @elseif ($row->status_approval_pembimbing2 === 1 ||
                                            $row->status_approval_kaprodi ===
                                            1)
                                            <span class="text-primary font-weight-bold">Diterima</span>
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            <a href="{{ route('laporan.skripsi.periksa.file-pembimbing2', $row->uuid) }}"
                                                class="btn btn-info btn-sm" target="_blank">
                                                <i class="fas fa-download mr-1"></i>
                                                Download
                                            </a>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                @if ($row->status_approval_pembimbing2 === 3)
                                                <form action="{{ route('laporan.skripsi.periksa.destroy') }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                @if ($row->status_approval_kaprodi === 3)
                                                <form action="{{ route('laporan.skripsi.periksa.destroy') }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <tr>
                                        <td>
                                            @if ($row->status_approval_pembimbing2 === null)
                                            <span class="right badge badge-danger">New</span>
                                            @elseif ($row->status_approval_pembimbing2 === 2)
                                            <span class="right badge badge-danger">New</span>
                                        ...
                                        <td>
                                            ...
                                            $row->status_approval_pembimbing2 != 3)
                                            <button type="button" class="btn btn-primary btn-sm btn-open-modal"
                                                value="{{ $row->uuid }}" data-toggle="modal"
                                            ...
                                            @endif
                                            @elseif ($row->file_pembimbing2 !== null)
                                            <a href="{{ route('laporan.skripsi.periksa.file-pembimbing2', $row->uuid) }}"
                                                class="btn btn-info btn-sm" target="_blank">
                                                <i class="fas fa-download mr-1"></i>
                                                Download
                                        ...
                                        <td>
                                            ...
                                            <span class="text-danger font-weight-bold">Ditolak</span>
                                            @elseif ($row->status_approval_pembimbing2 === 3)
                                            <span class="text-danger font-weight-bold">Ditolak ke Pembimbing 1</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($row->status_approval_kaprodi === 4)
                                            <span class="text-danger font-weight-bold">Ditolak Kaprodi</span>
                                            @elseif ($row->status_approval_kaprodi ===
                                            1)
                                            <span class="text-primary font-weight-bold">Diterima</span>
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            <a href="{{ route('laporan.skripsi.periksa.file-kaprodi', $row->uuid) }}"
                                                class="btn btn-info btn-sm" target="_blank">
                                                <i class="fas fa-download mr-1"></i>
                                                Download
                                            </a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Upload File Hasil Periksa Laporan Pembimbing 1</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('laporan.skripsi.periksa.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="pembimbing" value="1">
...
<div class="modal fade" id="uploadModalPembimbing2">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Upload File Hasil Periksa Laporan Pembimbing 2</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route(
                'laporan.skripsi.periksa.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="pembimbing" value="2">
                    <input type="hidden" name="laporan_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="icheck-danger">
                            ...
                            <label for="penilaiKeduaDanger2">Ditolak ke Pembimbing Sebelumnya</label>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#uploadModalProdi').on('hidden.bs.modal', function() {
        $(this).find('input[name="laporan_id"]').val('');
    });
