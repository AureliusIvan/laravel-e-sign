            ...
            <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="card-tools">
                  <a href="{{ route('pengaturan.create') }}" class="btn btn-primary btn-sm">
              ...
              <table id="program-studi" class="table table-bordered table-striped" style="font-size: 1em; width: 100%;">
                <thead>
                  <tr>
                    ...
                    <th style="width: 50%;">Pengaturan Program Studi</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info btn-sm btn-edit-data mr-1" href="{{ route('pengaturan.edit', $d->uuid) }}">
