      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="card card-outline card-info scroll">
            ...
            <div class="card-body">
              <!-- Form -->
              <form id="formTambah" method="post" action="{{ route('tahunajaran.store') }}">
                @csrf
                <!-- Tahun -->
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" id="inputTahun" class="form-control @error('tahun')
                                            is-invalid
                                        @enderror" name="tahun" placeholder="Enter Tahun" value="{{ old('tahun') }}"
                      min="2000" required>
                ...
                <div class="d-flex flex-row">
                  ...
                  <div class="mr-2">
                    <a href="{{ route('tahunajaran') }}" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
